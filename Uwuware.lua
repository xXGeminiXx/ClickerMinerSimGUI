...
local function round(num, bracket)
    ...
    local a = math.floor(num/bracket + (math.sign(tonumber(num)) * 0.5)) * bracket
    if a < 0 then
        a = a + bracket
    end
    return a
...
local function createOptionHolder(holderTitle, parent, parentTable, subHolder)
    ...
    local closeHolder = InstanceNew("Frame", {
    ...
    local close = InstanceNew("ImageLabel", {
    ...
    parentTable.content = InstanceNew("Frame", {
    ...
    layout.Changed:connect(function()
        ...
        parentTable.main.Size = #parentTable.options > 0 and parentTable.open and UDim2.new(0, 280, 0, layout.AbsoluteContentSize.Y + size) or UDim2.new(0, 280, 0, size)
    end)
    if not subHolder then
    ...
    closeHolder.InputBegan:connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 then
            ...
            parentTable.main:TweenSize(#parentTable.options > 0 and parentTable.open and UDim2.new(0, 280, 0, layout.AbsoluteContentSize.Y + size) or UDim2.new(0, 280, 0, size), "Out", "Quad", 0.2, true)
        end
    end)
...
function createButton(option, parent)
    ...
    local round = InstanceNew("ImageLabel", {
        AnchorPoint = Vector2.new(0.5, 0.5),
        Position = UDim2.new(0.5, 0, 0.5, 0),
...
local function createBind(option, parent)
    ...
    local bindinput = InstanceNew("TextLabel", {
        Size = UDim2.new(1, 0, 1, 0),
        BackgroundTransparency = 1,
        Text = text,
        TextSize = 16,
...
local function createSlider(option, parent)
    ...
    local slider = InstanceNew("ImageLabel", {
    ...
    local fill = InstanceNew("ImageLabel", {
        BackgroundTransparency = 1,
        Image = "rbxassetid://3570695787",
    ...
    local circle = InstanceNew("ImageLabel", {
        AnchorPoint = Vector2.new(0.5, 0.5),
    ...
    local valueRound = InstanceNew("ImageLabel", {
        Position = UDim2.new(1, -6, 0, 4),
    ...
    local inputvalue = InstanceNew("TextBox", {
        Size = UDim2.new(1, 0, 1, 0),
        BackgroundTransparency = 1,
        Text = option.value,
...
local function createList(option, parent, holder)
    ...
    local listvalue = InstanceNew("TextLabel", {
    ...
    option.mainHolder = InstanceNew("ImageButton", {
        ZIndex = 3,
    ...
    local content = InstanceNew("ScrollingFrame", {
        ZIndex = 3,
        Size = UDim2.new(1, 0, 1, 0),
        BackgroundTransparency = 1,
        BorderSizePixel = 0,
...
local function createBox(option, parent)
    ...
    local outline = InstanceNew("ImageLabel", {
        Position = UDim2.new(0, 6, 0, 4),
        Size = UDim2.new(1, -12, 1, -10),
        BackgroundTransparency = 1,
        Image = "rbxassetid://3570695787",
...
local function createColorPickerWindow(option)
    ...
    option.hue = InstanceNew("ImageLabel", {
        ZIndex = 3,
    ...
    option.hueSlider = InstanceNew("Frame", {
        ZIndex = 3,
    ...
    option.satval = InstanceNew("ImageLabel", {
        ZIndex = 3,
    ...
    option.satvalSlider = InstanceNew("Frame", {
        ZIndex = 3,
        AnchorPoint = Vector2.new(0.5, 0.5),
    ...
    option.visualize2 = InstanceNew("ImageLabel", {
        ZIndex = 3,
    ...
    option.resetColor = InstanceNew("ImageLabel", {
        ZIndex = 3,
    ...
    option.resetText = InstanceNew("TextLabel", {
        ZIndex = 3,
        Size = UDim2.new(1, 0, 1, 0),
        BackgroundTransparency = 1,
        Text = "Reset",
    ...
    option.undoColor = InstanceNew("ImageLabel", {
        ZIndex = 3,
    ...
    option.undoText = InstanceNew("TextLabel", {
        ZIndex = 3,
        Size = UDim2.new(1, 0, 1, 0),
        BackgroundTransparency = 1,
        Text = "Undo",
    ...
    option.setColor = InstanceNew("ImageLabel", {
        ZIndex = 3,
    ...
    option.setText = InstanceNew("TextLabel", {
        ZIndex = 3,
        Size = UDim2.new(1, 0, 1, 0),
        BackgroundTransparency = 1,
        Text = "Set",
    ...
    option.rainbow = InstanceNew("ImageLabel", {
        ZIndex = 3,
    ...
    option.rainbowText = InstanceNew("TextLabel", {
        ZIndex = 3,
        Size = UDim2.new(1, 0, 1, 0),
        BackgroundTransparency = 1,
        Text = "Rainbow",
...
local function createColor(option, parent, holder)
    option.main = InstanceNew("TextLabel", {
        LayoutOrder = option.position,
        Size = UDim2.new(1, 0, 0, 31),
        BackgroundTransparency = 1,
        Text = " " .. option.text,
    ...
    local colorBoxOutline = InstanceNew("ImageLabel", {
        Position = UDim2.new(1, -6, 0, 4),
        Size = UDim2.new(-1, 10, 1, -10),
        SizeConstraint = Enum.SizeConstraint.RelativeYY,
        BackgroundTransparency = 1,
    ...
    option.visualize = InstanceNew("ImageLabel", {
        Position = UDim2.new(0, 2, 0, 2),
        Size = UDim2.new(1, -4, 1, -4),
        BackgroundTransparency = 1,
        Image = "rbxassetid://3570695787",
...
local function getFnctions(parent)
    ...
    function parent:AddToggle(option)
        ...
        option.nopanic = typeof(option.nopanic) == "boolean" and option.nopanic or false
...
function library:Init()
    ...
    self.base = self.base or InstanceNew("ScreenGui")
    self.base.Parent = game:GetService"CoreGui"
    InstanceNew("StringValue", {
...
function library:Panic()
    for _, v in pairs(library.objects.toggles) do
        if v.state then
            v:SetState(false)
        end
    end
